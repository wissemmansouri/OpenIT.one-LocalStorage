...
readonly OPEN_SERVICES=(
    "openit-local-storage.service"
)

readonly OPEN_EXEC=openit-local-storage
readonly OPEN_CONF=/etc/openit/local-storage.conf
readonly OPEN_DB=/var/lib/openit/db/local-storage.db
