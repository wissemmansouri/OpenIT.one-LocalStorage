...
const (
         localStorageConfigDirPath  = "/etc/openit"
         localStorageConfigFilePath = "/etc/openit/local-storage.conf"
         localStorageName           = "openit-local-storage.service" 
         localStorageNameShort      = "local-storage"
)

//go:embedded ../../build/sysroot/etc/openit/local-storage.conf.sample
